...
class Cartridge
  ...
  field :base_link_template, type: String, default: "$entity_id"
  field :base_list_template, type: String, default: "$page_number"
  field :reaping_type, type: Symbol, default: :page # :page, :list, :mixed

  # Parametres for list type of reaping
  # Example: { "start" => 1, "end" => ''}
  field :list_offset, type: Hash, default: { "start" => '', "end" => '' }
